...
def fetch_worldbank(
    ...
    for ind_id in ind_list:
        ...
        try:
            ...
            if len(data) < 2:
                continue
            region_aggregates = {"Africa", "World", "Arab World", "Caribbean small states", "Central Europe and the Baltics", "East Asia & Pacific", "East Asia & Pacific (IDA & IBRD)", "Europe & Central Asia", "Europe & Central Asia (IDA & IBRD)", "European Union", "Fragile and conflict affected situations", "Heavily indebted poor countries (HIPC)", "High income", "IBRD only", "IDA & IBRD total", "IDA blend", "IDA only", "IDA total", "Latin America & Caribbean", "Latin America & Caribbean (excluding high income)", "Latin America & the Caribbean (IDA & IBRD)", "Least developed countries: UN classification", "Low & middle income", "Low income", "Lower middle income", "Middle East & North Africa", "Middle East & North Africa (IDA & IBRD)", "Middle income", "North America", "OECD members", "Other small states", "Pacific island small states", "Post-demographic dividend", "Pre-demographic dividend", "Small states", "South Asia", "South Asia (IDA & IBRD)", "Sub-Saharan Africa", "Sub-Saharan Africa (IDA & IBRD)", "Sub-Saharan Africa (excluding high income)", "Sub-Saharan Africa (excluding South Africa)", "Upper middle income", "North America", "Euro area", "Early-demographic dividend", "Late-demographic dividend", "East Asia & Pacific (all income levels)", "Europe & Central Asia (all income levels)", "Latin America & Caribbean (all income levels)", "Middle East & North Africa (all income levels)", "South Asia (all income levels)", "Sub-Saharan Africa (all income levels)", "Arab States", "Bahrain, Kingdom of", "Brunei Darussalam", "Democratic People's Republic of Korea", "Dem. Rep. Congo", "Egypt, Arab Rep.", "Equatorial Guinea", "Gabon", "Iran, Islamic Rep.", "Korea, Dem. People's Rep.", "Korea, Rep.", "Kuwait", "Lao PDR", "Macao SAR, China", "Micronesia, Fed. Sts.", "Myanmar", "Nauru", "Palau", "Russian Federation", "Sint Maarten (Dutch part)", "Solomon Islands", "Syrian Arab Republic", "Tonga", "Tuvalu", "Vanuatu", "Venezuela, RB", "Yemen, Rep.", "Andorra", "Antigua and Barbuda", "Bahamas, The", "Barbados", "Belize", "Bermuda", "Bolivia", "British Virgin Islands", "Cabo Verde", "Cayman Islands", "Channel Islands", "Comoros", "Congo, Dem. Rep.", "Congo, Rep.", "Cook Islands", "Costa Rica", "Cuba", "Curacao", "Dominica", "Dominican Republic", "El Salvador", "Eswatini", "Fiji", "French Polynesia", "Grenada", "Guatemala", "Guinea-Bissau", "Guyana", "Haiti", "Honduras", "Iraq", "Jamaica", "Kiribati", "Lebanon", "Lesotho", "Marshall Islands", "Mauritius", "Monaco", "Montenegro", "Nauru", "New Caledonia", "Nicaragua", "Niue", "Palau", "Panama", "Papua New Guinea", "Paraguay", "Puerto Rico", "Samoa", "San Marino", "Sao Tome and Principe", "Seychelles", "Singapore", "St. Kitts and Nevis", "St. Lucia", "St. Martin (French part)", "St. Vincent and the Grenadines", "Suriname", "Timor-Leste", "Togo", "Tonga", "Trinidad and Tobago", "Tuvalu", "Uruguay", "Vanuatu", "Venezuela, RB", "Virgin Islands", "West Bank and Gaza", "Africa Eastern and Southern", "Africa Western and Central", "Central Asia", "Eastern Asia", "Eastern Europe", "Latin America and the Caribbean", "Northern Africa and Western Asia", "Northern America", "Northern Europe", "South-eastern Asia", "Southern Asia", "Southern Europe", "Sub-Saharan Africa", "Western Asia", "Western Europe"}
            for item in data[1]:
                country_raw = item.get("country", {}).get("value", "")
                country = normalize_country(country_raw)
                value = item.get("value")
                year = item.get("date")
                # Skip region aggregates and empty countries
                if not country or value is None:
                    continue
                if country in region_aggregates or country_raw in region_aggregates:
                    continue
